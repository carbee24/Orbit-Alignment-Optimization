from SA4StandEnv import SA_1_Round
...
if __name__ == "__main__":
    ...
    # 创建一个文件处理器
    file_handler = logging.FileHandler('sa_log.txt', 'w')
    ...
    logger.info("SA Cost {} mins..".format((end_time - start_time)/60))
    ...
    with pd.ExcelWriter("./sa_opt_result.xlsx", engine='openpyxl') as writer:
    ...
    np.save("sa_distances_opt.npy", distances)