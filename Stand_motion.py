...
class Stand6_Template():
    ...
    def single_step_move(self, ACTION, step_length):
        xy_step_length = step_length[0]
        angle_step_length = step_length[1]
        if ACTION == 0:
            self.body_1.position += xy_step_length, 0
        elif ACTION == 1:
            self.body_1.position -= xy_step_length, 0
        elif ACTION == 2:
            self.body_1.position += 0, xy_step_length
        elif ACTION == 3:
            self.body_1.position -= 0, xy_step_length
        elif ACTION == 4:
            self.body_1.angle += angle_step_length
        else:
            self.body_1.angle -= angle_step_length
