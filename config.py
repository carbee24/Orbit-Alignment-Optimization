...
def get_args():
    ...
    parser.add_argument('--env_name',default='Stand_Env',type=str,help="name of environment")
    ...
    parser.add_argument('--memory_capacity',default=500,type=int,help="memory capacity")
...
def plot_rewards(rewards,cfg, tag='train'):
    ...
    plt.xlabel('epsiodes')
    plt.plot(rewards, label='distance')
